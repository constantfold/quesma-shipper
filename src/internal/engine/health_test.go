...
func TestHeartbeat(t *testing.T) {
	...
	rep := formats.Report{StartedAt: now, Sources: []formats.SourceOutcome{
		{SourceID: "claude-code-transcripts", Family: "claude-code", Health: formats.Collected, Sniff: formats.SniffOK,
			AgentVersion: "2.1.220", Files: []formats.FileOutcome{
				{Decision: auditlog.DecisionShipped, Density: 0.02, NativePath: "/Users/__USER__/.claude/projects/p/a.jsonl",
